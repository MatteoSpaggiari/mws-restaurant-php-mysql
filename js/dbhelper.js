...
class DBHelper {
    ...
    */
    static RESTAURANTS_DATABASE_URL(id = null) {
        ...
        if(id) {
            return `http://localhost/server-php-mws-restaurant/server.php?id=${id}`;
        } else {
            return `http://localhost/server-php-mws-restaurant/server.php?getall=`;
        }
    }
    ...
    */
    static REVIEWS_DATABASE_URL(restaurant_id = null) {
        const port = 80; // Change this to your server port
        if(restaurant_id) {
            return `http://localhost/server-php-mws-restaurant/server.php?reviews_restaurant_id=${restaurant_id}`;
        } else {
            return `http://localhost/server-php-mws-restaurant/server.php?reviews=`;
        }
    }
    ...
    */
    static putIsFavoriteRestaurantDatabase(id_restaurant, favorite, favoriteHTML) {
        ...
        fetch(DBHelper.RESTAURANTS_DATABASE_URL(id_restaurant)+is_favorite,
        {
            method: "GET",
    ...
    */
    static getReviewsRestaurantValuesDatabase(restaurant_id,callback) {
        ...
        dbPromise.then(function(db) {
            ...
            return reviewsRestaurantIndex.openCursor(restaurant_id);
